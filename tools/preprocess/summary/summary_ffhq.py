...
if __name__ == '__main__':
    ...
    parser.add_argument("--origin_dataset_dir", type=str, default="/mldisk2/deid/FFHQ/origin/512_resize", help="parameter file path")
    parser.add_argument("--face_ratio_dir", type=str, default="/mldisk2/deid/FFHQ/origin/eval", help="parameter file path")
