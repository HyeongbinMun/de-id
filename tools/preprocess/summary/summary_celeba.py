...
if __name__ == '__main__':
    ...
    parser.add_argument("--origin_dataset_dir", type=str, default="/mldisk2/deid/celeba-world/origin/split", help="parameter file path")
    parser.add_argument("--face_ratio_dir", type=str, default="/mldisk2/deid/celeba-world/origin/eval", help="parameter file path")
